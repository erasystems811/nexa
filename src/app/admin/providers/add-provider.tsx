...
/** Add a provider manually (Section 12). */
  ...
  return (
    <form action={action} className="rounded-[var(--radius-card)] border border-[color:var(--color-line)] bg-white p-4">
      ...
      <p className="mt-1 text-xs text-[color:var(--color-ink-muted)]">
        Creates an account and approves it. Sets their deposit % on the agreement.
      </p>
      ...
      {state.ok ? <div className="mt-2"><Alert tone="success">Provider added.</Alert></div> : null}
